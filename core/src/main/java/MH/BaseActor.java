...
public class BaseActor extends Group {
    ...
    public void boundToWorld(){
        ...
        setX(MathUtils.clamp(0, getX(), worldBounds.width - getWidth())); // check left, right edge
        setY(MathUtils.clamp(0, getY(), worldBounds.height - getHeight())); // check top, bottom edge
    }
